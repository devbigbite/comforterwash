const es = {
  ...
  hero: {
    ...
    slide3Sub: "Lavado y doblado desde $2.69/lb · Edredones desde $33",
  ...
  steps: {
    heading: "¡Ropa Limpia en 4 Simples Pasos!",
    ...
    step3Title: "Lavamos y Doblamos",
    step3Desc: "Cada prenda es lavada, secada y doblada con cuidado por nuestro equipo.",
    step3Cta: "Ver Precios »",
    step4Title: "Disfruta tu Tiempo Libre",
    step4Desc: "Tu ropa será devuelta limpia, doblada y entregada a tu puerta.",
    step4Cta: "Agenda una Recogida »",
  ...
  pricing: {
    ...
    washFoldPrice: "$2.69",
    washFoldUnit: "por lb",
    washFoldMin: "mínimo 18 lb · clasificado y doblado",
    washFoldSub: "desde $2.55/lb con suscripción",
    ...
    washOnlyPrice: "$2.19",
    washOnlyUnit: "por lb",
    washOnlyMin: "mínimo 18 lb · devuelta limpia, sin doblar",
  ...
  faq: {
    ...
    a1: "Lavado de Edredón es para edredones — desde $33 cada uno (el precio varía según el tamaño). Lavado y Doblado es para ropa regular: lavada, secada y doblada a $2.69/lb (o $2.55/lb con suscripción). Solo Lavado es a $2.19/lb — la ropa se devuelve limpia en una bolsa, sin doblar.",
    ...
    a3: "Estimas el peso al reservar y pesamos tu ropa en la recogida. Confirmamos el precio final después de pesar. Aplica mínimo de 18 lb.",
  ...
  form: {
    ...
    specialInstructionsPlaceholder: "Cualquier cosa que nuestro equipo deba saber sobre este pedido — p. ej. \"el código del portón es 1234\" o \"deja las bolsas en el porche lateral.\"",
    savePreferencesLabel: "¿Guardar estas preferencias para todos mis pedidos futuros?",
    savePreferencesSub: "Tus elecciones de detergente y complementos se aplicarán automáticamente a cada recogida recurrente. Desmarca si este pedido es diferente de tu pedido habitual.",
  ...
  washFoldForm: {
    ...
    tierLockInBag:         "Precio fijo por bolsa · descuento por suscripción · día fijo de recogida",
    tierLockInBoth:        "Precio por peso o por bolsa · descuento por suscripción · día fijo de recogida",
    tierWeekly:            "Semanal",
    ...
    tierMinPickups:        "(Mínimo {n} recogidas · luego cancela cuando quieras)",
    tierNoMinPickups:      "Cancela cuando quieras — sin mínimo",
    ...
    chargedAt:     "Se cobra a {priceLabel} · mínimo 18 lb. Pesamos en la recogida y cobramos el monto exacto.",
    chargedAtSummary: "Se cobra a {priceLabel} · mínimo 18 lb. Cargo final ajustado al peso real después de la recogida.",
