const en = {
  ...
  hero: {
    ...
    slide3Sub: "Professional wash & fold starting at $2.69/lb · Comforters from $33",
  ...
  services: {
    ...
    washFoldDesc: "We pick up your dirty clothes right from your door, then bring them back washed, dried, and neatly folded.",
    washFoldUnit: "per lb · 18 lb min",
    details: "Book Now",
    perComforter: "per comforter",
  ...
  steps: {
    heading: "Clean Laundry in 4 Simple Steps!",
    ...
    step3Title: "We Wash & Fold",
    step3Desc: "Every item is washed, dried, and neatly folded with care by our team.",
    step3Cta: "See Pricing »",
    step4Title: "Enjoy Your Free Time",
    step4Desc: "Your laundry will be returned clean, folded, and delivered to your door.",
    step4Cta: "Schedule a Pickup »",
  ...
  pricing: {
    ...
    washFoldPrice: "$2.69",
    washFoldUnit: "per lb",
    washFoldMin: "18 lb minimum · sorted & folded",
    washFoldSub: "from $2.55/lb with subscription",
    ...
    washOnlyPrice: "$2.19",
    washOnlyUnit: "per lb",
    washOnlyMin: "18 lb minimum · returned clean, unfolded",
  ...
  faq: {
    ...
    a1: "Comforter Wash is for comforters — from $33 each (price varies by size). Wash & Fold is for regular clothes: washed, dried, and folded at $2.69/lb (or $2.55/lb with a weekly/biweekly subscription). Wash Only is a lower-cost option at $2.19/lb — clothes are washed and returned clean in a bag, unfolded.",
    ...
    a3: "You estimate your weight when booking, and we weigh your laundry at pickup. We'll confirm the final price after weighing. 18 lb minimum applies.",
  ...
  form: {
    ...
    specialInstructionsPlaceholder: "Anything our team should know about this order — e.g. \"gate code is 1234\" or \"leave bags on the side porch.\"",
    savePreferencesLabel: "Save these preferences for all my future orders?",
    savePreferencesSub: "Your detergent and add-on choices will be applied automatically to every recurring pickup. Uncheck if this order is different from your usual.",
  ...
  washFoldForm: {
    ...
    tierLockInBag:         "Flat price per bag · subscription discount · fixed pickup day",
    tierLockInBoth:        "Priced by weight or bag · subscription discount · fixed pickup day",
    tierWeekly:            "Weekly",
    ...
    tierMinPickups:        "(Minimum {n} pickups · then cancel whenever you want)",
    tierNoMinPickups:      "Cancel anytime — no minimum",
    ...
    chargedAt:     "Charged at {priceLabel} · 18 lb minimum. We weigh at pickup and charge the exact amount.",
    chargedAtSummary: "Charged at {priceLabel} · 18 lb minimum. Final charge adjusted to actual weight after pickup.",
  ...
  serviceAreasPage: {
    ...
    subtitlePaidDelivery: "We serve your local area — schedule your pickup and delivery today.",
