...
export default function DriverOrderClient({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ══════════════════════════════════════════════════════════════ */}
      {/* DELIVERY PHASE                                                 */}
      {/* Completed entirely in this app — photo + confirm button for    */}
      {/* both legs. Shipday is admin-only now (route ordering), so       */}
      {/* there's no longer a second app racing to close the same order. */}
      {/* ══════════════════════════════════════════════════════════════ */}
      {showDelivery && (
            ...
            {(allReadyAtWarehouse || (allReady && !allReadyAtWarehouse && !allOutForDel)) && (
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Start the delivery run once you have the bags.</p>
                </div>
