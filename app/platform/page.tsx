...
const FEATURES: { icon: string; en: { title: string; desc: string }; es: { title: string; desc: string } }[] = [
  ...
  { icon: "🛏️", en: { title: "A Dedicated Comforter Service", desc: "Comforters get their own booking flow, sizing, and pricing — not just another line item on a wash & fold list. Most laundry software has no idea what to do with a comforter order; ours is built around it." },
    es: { title: "Un Servicio Dedicado para Cobertores", desc: "Los cobertores tienen su propio flujo de reserva, tamaños y precios — no solo otro artículo más en la lista de lavado y doblado. La mayoría del software de lavandería no sabe qué hacer con un pedido de cobertor; el nuestro está construido pensando en eso." } },
