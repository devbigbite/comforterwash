      ...
      .insert([
        {
          ...
          service_type: "wash_fold", num_bags: 2, num_comforters: 1, total_amount: 0,
          status: "confirmed", phase: "intake",
          pickup_date: today, delivery_date: tomorrow, pickup_time_window: "9am-1pm",
          delivery_time_window: "9am-1pm", price_per_lb_cents: 250,
        },
        {
        ...
        },
        {
          ...
          service_type: "wash_fold", num_bags: 2, num_comforters: 1, total_amount: 0,
          status: "out_for_delivery", phase: "delivery",
          pickup_date: today, delivery_date: today, pickup_time_window: "9am-1pm",
          delivery_time_window: "9am-1pm", price_per_lb_cents: 250,
        },
      ])
      .select("id, short_code, status")
