...
export default async function WashFoldPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fb]">
      ...
      <ServiceSwitcher defaultService="wash_fold" services={services} pricing={pricing} washFoldBagConfig={washFoldBagConfig} monthlyPlanEnabled={monthlyPlanEnabled} timezone={timezone} />
    </main>
  )
}
