...
export default function HeroCarousel({
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#0D2240]" style={{ minHeight: "clamp(460px, 70vw, 580px)" }}>
      ...
      <div className={`absolute inset-x-0 bottom-0 bg-gradient-to-b from-transparent to-[#0D2240] pointer-events-none z-10 ${slide.type === "steps" ? "h-16" : "h-56"}`} />
      ...
      <button
        ...
        aria-label="Next"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M9 18l6-6-6-6" /></s