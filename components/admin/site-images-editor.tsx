      ...
      {SITE_IMAGE_SLOTS.map(slot => {
        ...
        return (
          <div key={slot.key} className="rounded-2xl border-2 border-[#0D2240]/10 bg-white shadow-sm overflow-hidden">
            ...
            {/* Preview — special for the hero banner, plain thumbnail for everything else */}
            {slot.key === "slide_1" && (
              <FullSlidePreview
                src={src}
            ...
            <div className="p-5 space-y-4">
              ...
              {slot.key === "slide_1" && (
                <div className="border-t border-gray-100 pt-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <p className="text-[11px] font-bold text-[#0D2240] uppercase tracking-wide">4-Step Overlay</p>
                    <LangTabs value={langTab} onChange={setLangTab} />
                  </div>
                  {langTab === "en" ? (
                    <>
                      {[
                        { n: 1, label: text.slide_2_p1_label, labelKey: "slide_2_p1_label" as const },
                        { n: 2, label: text.slide_2_p2_label, labelKey: "slide_2_p2_label" as const },
                        { n: 3, label: text.slide_2_p3_label, labelKey: "slide_2_p3_label" as const },
                        { n: 4, label: text.slide_2_p4_label, labelKey: "slide_2_p4_label" as const },
                      ].map(p => (
                        <div key={p.n} className="rounded-xl bg-gray-50 p-3 space-y-2">
                          ...
                          <TextField label="Label" value={p.label} defaultValue={DEFAULT_TEXT[p.labelKey]} placeholder="YOU ORDER" onSave={v => saveText(p.labelKey, v)} />
                        </div>
                      ))}
                    </>
                  ) : (
                    <>
                      <p className="text-[10px] text-gray-400 italic">Leave blank to use Spanish translation automatically.</p>
                      {[
                        { n: 1, label: text.slide_2_p1_label_es, labelKey: "slide_2_p1_label_es" as const },
                        { n: 2, label: text.slide_2_p2_label_es, labelKey: "slide_2_p2_label_es" as const },
                        { n: 3, label: text.slide_2_p3_label_es, labelKey: "slide_2_p3_label_es" as const },
                        { n: 4, label: text.slide_2_p4_label_es, labelKey: "slide_2_p4_label_es" as const },
                      ].map(p => (
                        <div key={p.n} className="rounded-xl bg-gray-50 p-3 space-y-2">
                          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wide">Paso {p.n} (ES)</p>
                          <TextField label="Etiqueta (ES)" value={p.label} defaultValue="" placeholder="TÚ ORDENAS" onSave={v => saveText(p.labelKey, v)} />
                        </div>
                      ))}
                    </>
                  )}
