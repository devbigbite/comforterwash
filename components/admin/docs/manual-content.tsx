...
// ── Tenant Manual (shared content) ───────────────────────────────────────────
// Rendered from two places: the logged-in /admin/manual page (for existing
// tenants) and the public /guide page (for prospects who don't have an
// account yet — so this content can't assume requireAdmin() has run, and
// must stay free of any tenant-specific data). Keeping it in one file means
// the two pages can never drift out of sync with each other.
